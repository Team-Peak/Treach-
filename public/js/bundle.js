...
exports.createPost = exports.updateSettings = exports.reset = exports.forgot = exports.signUp = exports.logOut = exports.login = void 0;
...
var signUp = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(fname, lname, email, password, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              window.setTimeout(function () {
                (0, _alerts.showAlert)('success', 'Welcome to treach');
                location.assign('/');
              }, 200);
            }
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Token sent to your email');
            }
...
var reset = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              window.setTimeout(function () {
                (0, _alerts.showAlert)('success', 'password reset successfull');
  ...
  return function reset(_x9, _x10, _x11) {
...
var createPost = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Post created successfully');
              location.reload();
            }
  ...
  return function createPost(_x13) {
...
var SignUpData = document.querySelector('.sign-form');
var forgotData = document.querySelector('.forgot');
var loginData = document.querySelector('.login-data');
var resetData = document.querySelector('.reset-data');
var imgForm = document.getElementById('add-image');
var postForm = document.querySelector('#postForm');
var post = document.querySelector('#post'); //handles login
...
if (SignUpData) {
  SignUpData.addEventListener('submit', function (e) {
    ...
    return (0, _script.signUp)(fname, lname, email, password, passwordConfirm);
  });
} //handles logging out


if (logOutBtn) {
  logOutBtn.addEventListener('click', _script.logOut);
} //handles sending reset token


if (forgotData) {
  forgotData.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email').value;
    (0, _script.forgot)(email);
  });
}

if (resetData) {
  resetData.addEventListener('submit', function (e) {
    e.preventDefault();
    var resetToken = document.querySelector('#token').value;
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    console.log(password, passwordConfirm, resetToken);
    (0, _script.reset)(password, passwordConfirm, resetToken);
  });
}
...
if (imgForm) imgForm.addEventListener('submit', function (e) {
  ...
  (0, _script.updateSettings)(form, 'data');
});
