...
exports.reset = exports.forgot = exports.signUp = exports.logOut = exports.login = void 0;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(fname, lname, email, password, passwordConfirm) {
    var res;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee5(password, passwordConfirm, resetToken) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/resetpassword/".concat(resetToken),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
...
var resetData = document.querySelector('.reset-data'); //handles login
